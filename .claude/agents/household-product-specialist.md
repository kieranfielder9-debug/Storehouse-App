...
description: Use for anything involving Ethan's Wisdom Wallet, family/household-scoped features, child accounts, chore-reward flows, or judging whether a proposed feature is still safely "personal/household use" versus crossing into a public offering.
...
- Phase 3 of the roadmap extends real functionality here in parallel with Phase 2, but deliberately stays scoped to literal household members under the account owner's own consent — not friends, not friends-of-friends.
